...
3. **`AGENT-GOALS.md`** — every goal currently held for the session, including implicit RLHF-shaped goals (be helpful, demonstrate competence, earn approval, reduce user frustration), not just the user-stated task.
